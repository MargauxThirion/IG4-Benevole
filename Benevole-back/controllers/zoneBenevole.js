  ...
  try {
    ...
    if (!horaireSpecifique) {
      return res
        .status(404)
        .json({
          message: "Horaire spécifique non trouvé dans la zone bénévole",
        });
    }
    ...
    if (
      !zoneAvecCapacite ||
      !zoneAvecCapacite.horaireCota ||
      !zoneAvecCapacite.horaireCota.length
    ) {
      return res
        .status(400)
        .json({ message: "Capacité maximale de la zone bénévole introuvable" });
    }

    const capaciteMaximale = zoneAvecCapacite.horaireCota.find(
      (h) => h._id.toString() === idHoraire
    )?.nb_benevole;
    ...
    if (typeof capaciteMaximale !== "number" || isNaN(capaciteMaximale)) {
      return res
        .status(400)
        .json({ message: "Capacité maximale de la zone bénévole non valide" });
    }
    ...
    if (zones.length > 0) {
      return res
        ...
        .json({
          message:
            "Le bénévole est déjà inscrit à une autre zone bénévole pour le même créneau horaire à la même date.",
        });
      ...
      return res
        ...
        .json({
          message:
            "Le bénévole est déjà inscrit à cette zone bénévole pour le même créneau horaire.",
        });
      ...
      return res
        ...
        .json({
          message:
            "Le créneau horaire de la zone bénévole est déjà complet, la capacité maximale est atteinte.",
        });
    }
